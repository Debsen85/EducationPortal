...
<div class="tab" style="top:0px;">
	...
	<li class="logo">Edocutal</li>
      ...
      <li><a href="http://localhost/WEB/php/dropdown.php">Colleges</a></li>
      <li><a href="http://localhost/WEB/php/examinations.php">Examinations</a></li>
      <li><a href="http://localhost/WEB/php/feedback.php">Feedback</a></li>
      <li><a href="http://localhost/WEB/php/login.php">Log Out</a></li>
      </ul></div>
    </header>
...
<div class="tab"x style="top:800px" >
  <ul class="tab">
    <li style="float:left;"><a href="../html/contactus1.html">Contact Us</a></li>
    <li style="float:left;"><a href="../html/terms&conditions1.html">Terms & Conditions</a></li>
  </ul>
</div>
